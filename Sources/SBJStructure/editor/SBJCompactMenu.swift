...
/// Shared compact menu presentation for generated scalar editors.
///
/// The value remains visually dense while the paired up/down chevrons make the
/// affordance explicit without requiring a large picker-style control.
@MainActor
struct SBJCompactMenuLabel: View {
    let text: String
